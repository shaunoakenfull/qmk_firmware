...
[_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,      KC_CAPS ,KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LGUI,KC_LALT,KC_LCTRL, KC_LOWER, KC_ENT,      KC_SPC,  TT(_RAISE), KC_RCTRL, KC_RALT, KC_PSCR
),
/*
 * QWERTY
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * | Shift|      |      |      |      |      |-------|    |-------|      |   1  |   2  |   3  |      | Shift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Enter  /       \Space \  |RAISE |   0  | RAlt | .    |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_RAISE] = LAYOUT(
  ...
  _______,   _______,  _______, _______, _______, _______, _______,       _______,  _______,    KC_1,    KC_2,    KC_3, _______, _______,
                       _______, _______, _______, _______, _______,       _______,  _______,    KC_0, _______,  KC_DOT
),
